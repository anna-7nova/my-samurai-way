...
Спасибо ребятам из it-incubator, так как для своих учеников был подготовлен отдельный репозиторий для удобного старта данного курса. Это полностью подготовленный проект для "Пути самурая", где установлены ВСЕ библиотеки нужных версий.
